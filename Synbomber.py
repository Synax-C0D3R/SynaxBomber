...
print("Запрос информации у сервера")

sleep ( 5 )

print("ответ сервера положительный")
...
╚══════╝   ╚═╝   ╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝  ╚═════╝ ╚═╝     ╚═╝╚═════╝ 
  ...
  email = _email
  os.system('cls' if os.name=='nt' else 'clear')
  print(logo+"\033[37mТелефон: \033[34m"+_phone+"\n\033[37m The spammer has been launched \033[0m\n")
  while True:
    try:
      try:
      ...
      try:
        ...
        pass
      iteration += 1
      print(("\033[37m{} SMS series sent \033[0m").format(iteration))
    except KeyboardInterrupt:
      os.system('cls' if os.name=='nt' else 'clear')
      print(logo+"\033[37mТелефон: \033[34m"+_phone+"\n\033[37m The spammer has been stopped \033[0m")
      time.sleep(2)
      main()
main()
